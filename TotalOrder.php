...
$sql = "SELECT * FROM orders,tbl_client WHERE orders.client_name= tbl_client.name";
...
foreach ($result as $row) {
    ...
    ?>
                                        <tr>
                                            ...
                                            <td><a href="viewMeasurement.php?id=<?php echo $row['order_id']?>"><button type="button" class="btn btn-xs btn-success" title="View Measurement" ><i class="fa fa-address-card"></i></button></a></td>
                                        </tr>
