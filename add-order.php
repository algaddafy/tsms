                    ...
                    <div class="col-lg-11" style="    margin-left: 5%;">
                                    ...
                                    <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
                                     ...
                                     <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                   <select class="form-control select2" id="mob_no" name="clientContact">
                        ...
                        $sql = "SELECT * FROM tbl_client WHERE delete_status =0";
                                ...
                                while($row = $result->fetch_array()) {
                                    echo "<option value='".$row['id']."'>".$row['mob_no']."</option>";
                                } // while
...
<!--                                                  <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete="off" />
 -->                                               </div>
   ...
   <option value="0">- Select -</option></select>  -->
                          <input type="text" class="form-control" id="clientName" name="clientName"   required style="color:black;" >
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-2 control-label">Select Delivery Type</label>
                                                <div class="col-sm-4">
                                                   <select class="form-control select2" id="clientName" name="deliverytype">
...
<!--                                                  <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete="off" />
 -->                                               </div>
                          ...
                          <input type="date" class="form-control" id="mob_no" name="deliverydate"   required style="color:black;" >
                                                </div>
...
<td >
            ...
            ?>
              ...
              <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue" />
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="vat" class="col-sm-2 control-label gst">Vat 0%</label>
                                                <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                <option value="">~~SELECT~~</option>
                <option value="1">In Narayanganj</option>
                <option value="2">Out Of Narayanganj</option>
              </select>
            </div>
                                               </div>
                                            </div>
