...
?>
    ...
    <div id="main-wrapper">
        <div class="unix-login">
            ...
            <div class="container-fluid" style="background-image: url('./assets/uploadImage/background.jpg');
                            ...
                            <div class="login-form">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                                   ...
                                   <div class="col-md-6 form-check">
                                    ...
                                    <button style="background-color:#5c2928; color:white;" type="submit" name="login" class="f-w-600 btn m-b-30 m-t-30">Sign in</button>
